...
contract NFTMarket is ReentrancyGuard {
    ...
    address payable owner; // owner of the smar contract
    ...
    /// @notice function to crate a sale
    function createMarketSale( address nftContract, uint256 itemId) public payable nonReentrant {
        ...
        // transfer ownership of the nft from contract itself to the buyer
    ...
    function fetchMarketItems() public view returns (MarketItem[] memory) {
        uint itemCount = _itemIds.current(); // total number of items ever creater
    ...
    function fetchMyNFTs() public view returns (MarketItem[] memory) {
        ...
        for (uint i = 0; i < totalItemCount; i++) {
            // get only the items that this user is the owner
